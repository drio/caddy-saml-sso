...
func main() {
	...
	err = idpServer.Store.Put("/users/drio", samlidp.User{
		Name:           "drio",
		HashedPassword: hashedPassword,
		Groups:         []string{"Users"},
		Email:          "drio@example.com",
		CommonName:     "David Rio",
		Surname:        "Rio",
		GivenName:      "David",
	})
	if err != nil {
	...
	err = idpServer.Store.Put("/users/jon", samlidp.User{
		Name:           "jon",
		HashedPassword: hashedPassword,
		Groups:         []string{"Users"},
		Email:          "jon@example.com",
		CommonName:     "Jon Mcdonough",
		Surname:        "Mcdonough",
		GivenName:      "Jon",
	})
	if err != nil {
	...
	err = idpServer.Store.Put("/users/larry", samlidp.User{
		Name:           "larry",
		HashedPassword: hashedPassword,
		Groups:         []string{"Users"},
		Email:          "larry@example.com",
		CommonName:     "Larry Thomas",
		Surname:        "Thomas",
		GivenName:      "Larry",
	})
	if err != nil {
